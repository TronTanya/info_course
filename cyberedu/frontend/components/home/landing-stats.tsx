...
export async function LandingStats() {
  ...
  return (
    <ScrollReveal>
      <section
        className="relative overflow-hidden rounded-3xl border border-border/90 bg-linear-to-br from-secondary/7 via-card to-cyan/6 px-6 py-12 shadow-card sm:px-10 sm:py-14"

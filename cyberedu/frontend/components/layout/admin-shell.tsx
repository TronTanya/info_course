...
export function AdminShell({
  ...
  return (
    <div className={cn("dashboard-grid dashboard-grid--with-sidebar min-w-0 flex-1 overflow-x-clip", className)}>
      ...
      <section className="dashboard-content ce-admin-shell ce-app-main-panel ce-lab-panel relative isolate min-w-0 max-w-full overflow-x-clip p-3 pb-6 sm:p-6 lg:p-8">

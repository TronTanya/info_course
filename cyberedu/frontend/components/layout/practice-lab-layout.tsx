...
export function PracticeLabLayout({ breadcrumb, header, main, aside, className }: PracticeLabLayoutProps) {
  return (
    <div className={cn("lab-shell ce-learn-lab ce-border-beam ce-animate-in min-w-0 overflow-x-clip", className)}>
      <header className="lab-shell-header relative px-4 py-5 sm:px-6 sm:py-6">
        ...
        <div className="relative mb-3 hidden h-0.5 w-24 rounded-full bg-linear-to-r from-primary via-cyan to-transparent sm:block" aria-hidden />

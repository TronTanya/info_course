...
> = {
  info: {
    shell: "border-primary/30 bg-primary/[0.06] ring-primary/15",
    label: "text-primary",
    icon: Info,
  },
  warning: {
    shell: "border-warning/35 bg-warning/[0.08] ring-warning/20",
    label: "text-warning",
    icon: AlertTriangle,
  },
  danger: {
    shell: "border-danger/35 bg-danger/[0.08] ring-danger/20",
    label: "text-danger",
    icon: ShieldAlert,
  },
  success: {
    shell: "border-success/35 bg-success/[0.08] ring-success/20",
    label: "text-success",
    icon: CheckCircle2,
  },
};

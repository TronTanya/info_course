...
export const cyber = {
  ...
  hero: "ce-cyber-hero hero-glow relative overflow-hidden rounded-3xl border border-primary/20 bg-card/80 shadow-card ring-1 ring-primary/10",
  ...
  monoLabel: "typo-label text-cyan/90",
  ...
  adminTable:
    "ce-glass overflow-hidden rounded-2xl border border-primary/20 shadow-card ring-1 ring-primary/10",
  adminMobileCard:
    "ce-admin-mobile-card ce-glass rounded-2xl border border-primary/20 p-4 shadow-card",
  adminKpi:
    "ce-glass ce-border-beam relative overflow-hidden rounded-2xl border border-primary/20 shadow-card ring-1 ring-primary/10",

/**
 * Общие Tailwind-классы примитивов UI (дизайн-система v2).
...
export const cardInteractive =
  `${cardSurface} ${transitionBase} hover:border-primary/25 hover:shadow-[var(--shadow-card-hover)]`;

export const inputSurface =
  `flex w-full min-h-11 rounded-2xl border border-border bg-card px-3 py-2.5 text-base text-foreground shadow-sm sm:text-sm placeholder:text-subtle-foreground ${transitionBase} hover:border-primary/30 ${focusRing} disabled:cursor-not-allowed disabled:opacity-50`;

...
import { AdminReviewDeleteButton } from "@/components/admin/admin-review-delete-button";
import { hideReviewAction, publishReviewAction } from "@/lib/actions/admin-reviews";
                    ...
                    {rows.map((r) => (
                      <div key={r.id} className="space-y-3 p-4">
                        ...
                        <div className="flex flex-col gap-2 pt-1">
                          ...
                          <AdminReviewDeleteButton reviewId={r.id} />
                        </div>
                      </div>
                    ))}
                  </div>

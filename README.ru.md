...
- **Безопасность** — RBAC, CSRF, rate limit, audit log, headers — [SECURITY_PLATFORM.md](./cyberedu/docs/SECURITY_PLATFORM.md)
...
RBAC (`USER` / `ADMIN`) · CSRF (Origin/Referer на API) · rate limit и login lockout (Redis в prod) · hardened cookies · `SecurityAuditLog` · CSP/HSTS · безопасные upload · server-side оценка и AI policy.

Обзор: `/security` · Threat model: [`THREAT_MODEL.md`](./cyberedu/docs/THREAT_MODEL.md) · Контроли: [`SECURITY.md`](./cyberedu/docs/SECURITY.md), [`SECURITY_PLATFORM.md`](./cyberedu/docs/SECURITY_PLATFORM.md).
